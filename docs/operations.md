...
- **Env:** `BLUEOCEAN_WALLET_SALT` (required in production), and usually `BLUEOCEAN_WALLET_FLOAT_IS_MAJOR=true` when BO sends `amount` as decimal major units (e.g. `0.3` EUR).

          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <button
                ...
                className="dark:bg-dark-900 flex h-11 w-full items-center rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-400 shadow-theme-xs placeholder:text-gray-400 hover:border-brand-300 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/30 dark:hover:border-brand-800 xl:w-[430px]"
              >

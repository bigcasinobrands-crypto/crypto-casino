            ...
            <div className="space-y-2.5 p-2.5 pb-3.5">
              <section className={sectionCard}>
                ...
                {!bonus ? (
                  ...
                  <p className="text-[13px] font-medium leading-relaxed text-casino-muted">
                    This offer is on your account — once a qualifying deposit is completed, the bonus and wagering will
                    apply.
                  </p>
                ) : null}
              ...
              {vip ? (
                <section className={sectionCard}>
                  ...
                  <p className="text-base font-black uppercase leading-tight tracking-wide text-casino-foreground sm:text-lg">
                    {vip.tier || '—'}
                  </p>

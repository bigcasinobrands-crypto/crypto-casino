...
const RAW_ESPORTS_NAV_FALLBACK: EsportsNavItem[] = [
  ...
  { id: 'eftarena', label: 'Escape from Tarkov: Arena', page: '/eftarena', logoUrl: '/esports/eftarena.png' },
  ...
  { id: 'worldoftanks', label: 'World of Tanks', page: '/worldoftanks', logoUrl: '/esports/worldoftanks.png' },
  ...
  { id: 'crossfire', label: 'Crossfire', page: '/crossfire', logoUrl: '/esports/crossfire.png' },
  { id: 'worldofwarcraft', label: 'World of Warcraft', page: '/worldofwarcraft', logoUrl: '/esports/worldofwarcraft.png' },

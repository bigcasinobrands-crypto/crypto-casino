 ...
 * bottom nav `205` (height `--casino-mobile-nav-offset` in `casino-shell.css`), wallet dropdown backdrops `199`/`219`,
 * wallet currency listbox portal `z-[340]`, game search `z-[240]`,
